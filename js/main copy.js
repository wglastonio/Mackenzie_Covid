...
const initialDate = new Date('2020-02-26');
...
function buildDateAndShowData() {
    ...
    getJSON(url, function(data) {
        var country = data[diff].Country;
        var cases = data[diff].Confirmed;
        var deaths = data[diff].Deaths;
        ...
        document.getElementById("content2").innerHTML =
            "<article class='result'>" +
                ...
                "<p class='result'>Casos Confirmados: " + cases + "</p>" +
                "<p class='result'>Recuperados: " + recovered + "</p>" +
                "<p class='result'>Mortes: " + deaths + "</p>" +
            "</article>";
    });
}
